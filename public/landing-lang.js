...
(function () {
  ...
  var EN = {
    ...
    storyTitle: "What it is, at a glance",
    storyDesc: "Four ideas. No jargon wall — just what you get.",
    storyKickerSheet: "256-bit encryption",
    storyTitleSheet: "Simple as a spreadsheet.",
    storyBodySheet: "Edit passwords like a sheet — sealed with AES-256.",
    storyKickerZk: "Zero-knowledge",
    storyTitleZk: "Nothing on the server.",
    storyBodyZk: "Only encrypted ciphertext syncs. Zero plaintext ever.",
    ...
    storyKickerPay: "Lifetime · no subscription",
    storyTitlePay: "Pay once. Done.",
    storyBodyPay: "No monthly fees. No renewals. Own it forever.",
    storyLabelSheet: "Spreadsheet-simple",
    storyLabelZk: "Zero-knowledge",
    storyLabelSync: "Web + mobile sync",
    storyLabelPay: "Pay once",
    storyAriaSheet: "Simple as a spreadsheet — AES-256 sealed editing",
    storyAriaZk: "Nothing on the server — zero-knowledge ciphertext only",
    storyAriaSync: "Web and mobile sync — one account everywhere",
    storyAriaPay: "Pay once lifetime plan — no subscription",
  ...
  var KO = {
    ...
    storyTitle: "한눈에 보는 My Password Vault",
    storyDesc: "네 가지 핵심. 긴 설명 대신, 바로 보이는 메시지.",
    storyKickerSheet: "256비트 암호화",
    storyTitleSheet: "스프레드시트처럼 간단합니다.",
    storyBodySheet: "시트처럼 비밀번호를 편집하고 AES-256으로 밀봉합니다.",
    storyKickerZk: "제로 널리지",
    storyTitleZk: "서버에는 아무것도 없습니다.",
    storyBodyZk: "동기화되는 것은 암호문뿐입니다. 평문은 절대 없습니다.",
    storyKickerSync: "웹 + 모바일 동기화",
    storyTitleSync: "한 계정. 어디서나.",
    storyBodySync: "웹과 앱에서 금고가 그대로 동기화됩니다.",
    storyKickerPay: "평생 · 구독 없음",
    storyTitlePay: "한 번 결제. 끝.",
    storyBodyPay: "월 요금 없음. 갱신 없음. 평생 소유.",
    storyLabelSheet: "스프레드시트처럼",
    storyLabelZk: "제로 널리지",
    storyLabelSync: "웹 + 앱 동기화",
    storyLabelPay: "한 번만 결제",
    storyAriaSheet: "스프레드시트처럼 편집 — AES-256으로 밀봉",
    storyAriaZk: "서버에는 아무것도 없음 — 제로 널리지 암호문만",
    storyAriaSync: "웹과 모바일 동기화 — 한 계정으로 어디서나",
    storyAriaPay: "평생 플랜 한 번 결제 — 구독 없음",
    featTitle: "흐름에 맞춘 설계",
    featDesc:
