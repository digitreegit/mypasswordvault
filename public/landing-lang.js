...
(function () {
  ...
  var EN = {
    ...
    storyAriaPay: "Free for 25 entries, then one-time $4.99 for unlimited — no subscription",
  ...
  var KO = {
    ...
    storyTitlePay: "최대 25개 무료. 그다음 $4.99",
    storyBodyPay:
