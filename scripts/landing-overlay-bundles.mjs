...
export default {
  cn: {
    ...
    landingFreeF3: "加密同步至您的 Supabase 项目（仅密文）",
    ...
    landingPaidF3: "同样的零知识模型 — 我们永远收不到您的主密码",
    landingPaidF4: "许可保存在账户中；在您登录的每台设备上可用",
  ...
  jp: {
    ...
    landingFreeF3: "Supabase プロジェクトへ暗号文のみ同期",
    ...
    landingPaidF3: "同じゼロ知識モデル — マスターパスワードは受け取りません",
    landingPaidF4: "ライセンスはアカウントに保存。ログインする全デバイスで利用可能",
  ...
  de: {
    ...
    landingFreeF3: "Verschlüsselte Sync zu Ihrem Supabase-Projekt (nur Geheimtext)",
    ...
    landingPaidF3: "Gleiches Zero-Knowledge-Modell — wir erhalten nie Ihr Masterpasswort",
    landingPaidF4: "Lizenz im Konto gespeichert; funktioniert auf jedem Gerät, auf dem Sie sich anmelden",
  ...
  fr: {
    ...
    landingFreeF3: "Synchronisation chiffrée vers votre projet Supabase (texte chiffré uniquement)",
    ...
    landingPaidF3: "Même modèle zéro connaissance — nous ne recevons jamais votre mot de passe principal",
    landingPaidF4: "Licence stockée sur le compte ; fonctionne sur chaque appareil où vous vous connectez",
  ...
  it: {
    ...
    landingFreeF3: "Sincronizzazione crittografata al tuo progetto Supabase (solo ciphertext)",
    ...
    landingPaidF3: "Stesso modello zero-knowledge — non riceviamo mai la password principale",
    landingPaidF4: "Licenza salvata sull’account; funziona su ogni dispositivo con cui accedi",
  ...
  id: {
    ...
    landingFreeF3: "Sinkron terenkripsi ke proyek Supabase Anda (hanya ciphertext)",
    ...
    landingPaidF3: "Model zero-knowledge yang sama — kami tidak pernah menerima kata sandi utama Anda",
    landingPaidF4: "Lisensi disimpan di akun; berfungsi di setiap perangkat tempat Anda masuk",
