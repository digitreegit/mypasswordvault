...
const TERMS_HTML = `
        ...
        <h1>Terms of Use</h1>
        <p class="sub">
          These Terms of Use (“Terms”) govern your access to the marketing site and your relationship to
          <strong>Skyface, LLC</strong> regarding <strong>My Password Vault</strong> (the “Product”). The Product itself may
          present additional in‑app terms where applicable (for example app store distribution).
        </p>
        <article class="landing-legal-article">
          <h2>1. Not professional advice</h2>
          <p>
            Materials on this site describe security concepts in general terms. They are <strong>not legal, financial, or
            compliance advice</strong>. You are responsible for your own security posture, regulatory obligations, and vendor
            agreements (including Supabase, Google OAuth, Stripe, and hosting providers you choose).
          </p>
          ...
          <p>
            You agree not to misuse the Product or infrastructure — including attempting unauthorized access, interfering with
            other users, or using the Product to violate applicable law. We may suspend access where reasonably necessary to
            protect users or systems.
          </p>
          <h2>4. Intellectual property</h2>
          <p>
            Branding, text, and visual assets on this site are owned by Skyface, LLC or its licensors unless otherwise noted.
            You may not copy or redistribute them for commercial purposes without permission.
          </p>
          ...
          <p>
            ...
            do. Continued use of the site after changes constitutes acceptance of the revised Terms where permitted by law.
          </p>
          <h2>8. Contact</h2>
          <p>
            Questions about these Terms:<br />
            Email <a href="mailto:contact@skyface.com">contact@skyface.com</a>
          </p>
        </article>
        <p class="landing-legal-updated"><em>Last updated: May 15, 2026</em></p>
`;
