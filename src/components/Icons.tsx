...
export function uiIconClass(className?: string): string {
...
const withUiIcon = (p: P) => ({
  ...p,
  className: uiIconClass(p.className),
});

export const Eye = (p: P) => (
  <svg {...base} {...withUiIcon(p)}>
...
export function GoogleIcon({ className }: { className?: string }) {
  return (
    <svg className={uiIconClass(className)} viewBox="0 0 24 24" aria-hidden>
      <path
        fill="#4285F4"
...
export function EmailIcon({ className }: { className?: string }) {
  return (
    <svg
      className={uiIconClass(className)}
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
