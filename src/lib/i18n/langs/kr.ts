...
export const MESSAGES_KR: Record<string, string> = {
  ...
  "vault.newEntry": "새 항목",
  "vault.sortBy": "정렬",
  "vault.sortDirection": "방향",
  "vault.sortAscending": "오름차순",
  "vault.sortDescending": "내림차순",
  ...
  "admin.statsFreeSignupsToday": "오늘 가입 (UTC)",
  "admin.statsSignupsTotal": "총 계정 수",
  "admin.statsSignupsPlatformHint": "iOS {{ios}} · Android {{android}} · 웹 {{web}}",
  "admin.statsSignupsTodayHint": "UTC 자정 이후 신규 계정 — App Store 다운로드 수가 아님",
  "admin.statsSignupsTodayDetail":
    "App Store / Play 다운로드 ≠ 계정 가입입니다. 계정을 만든 사용자만 여기 집계됩니다.",
  "admin.statsDownloadsVsSignupsHint":
    "App Store 최초 다운로드는 iOS 가입보다 많을 수 있습니다 (설치만 하고 가입 안 한 경우).",
  ...
  "admin.statsByRegionSignups": "지역별 가입",
  ...
  "admin.totalCount": "총 {{total}}건 · {{page}}/{{pages}}페이지",
  "admin.pageRange": "{{from}}–{{to}} / {{total}}건",
