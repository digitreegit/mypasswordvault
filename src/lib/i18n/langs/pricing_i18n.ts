...
export const PRICING_DE: Record<string, string> = {
  ...
  "pricing.paidF4":
    "Dauerlizenz auf diesem Konto; unbegrenzte Einträge ohne Pause bei 25",
...
export const PRICING_FR: Record<string, string> = {
  ...
  "pricing.paidF4":
    "Licence permanente sur ce compte ; entrées illimitées, sans pause à 25",
...
export const PRICING_IT: Record<string, string> = {
  ...
  "pricing.paidF4":
    "Licenza permanente su questo account; voci illimitate, senza pausa a 25",
...
export const PRICING_CN: Record<string, string> = {
  ...
  "pricing.paidF4": "此账户永久许可；条目无上限，不受 25 条暂停限制",
...
export const PRICING_JP: Record<string, string> = {
  ...
  "pricing.paidF4": "このアカウントに永久ライセンス — 件数無制限、25 件での一時停止なし",
...
export const PRICING_ID: Record<string, string> = {
  ...
  "pricing.paidF4":
    "Lisensi permanen di akun ini; entri tak terbatas tanpa jeda di 25",
