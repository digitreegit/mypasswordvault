...
export const PRICING_ES: Record<string, string> = {
  ...
  "pricing.freeF3": "Sincronización cifrada con tu proyecto Supabase (solo texto cifrado)",
  ...
  "pricing.tierPaid": "Licencia permanente",
  ...
  "pricing.paidF1": "Entradas de contraseña ilimitadas",
  "pricing.paidF2": "Todo lo del plan Gratis, sin límite de entradas",
  "pricing.paidF3": "El mismo modelo de cero conocimiento: nunca recibimos tu contraseña maestra",
  "pricing.paidF4": "Licencia guardada en tu cuenta; válida en todos los dispositivos donde inicies sesión",
...
export const PRICING_DE: Record<string, string> = {
  ...
  "pricing.freeF3": "Verschlüsselte Sync zu deinem Supabase-Projekt (nur Geheimtext)",
  ...
  "pricing.paidF1": "Unbegrenzte Passwort-Einträge",
  "pricing.paidF2": "Alles aus Kostenlos, plus kein Eintragslimit",
  "pricing.paidF3": "Gleiches Zero-Knowledge-Modell — wir erhalten nie dein Masterpasswort",
  "pricing.paidF4": "Lizenz im Konto gespeichert; funktioniert auf jedem Gerät, auf dem du dich anmeldest",
...
export const PRICING_FR: Record<string, string> = {
  ...
  "pricing.freeF3": "Synchronisation chiffrée vers votre projet Supabase (texte chiffré uniquement)",
  ...
  "pricing.tierPaid": "Licence permanente",
  ...
  "pricing.paidF1": "Entrées de mots de passe illimitées",
  "pricing.paidF2": "Tout le plan Gratuit, plus aucune limite d’entrées",
  "pricing.paidF3": "Même modèle zéro connaissance — nous ne recevons jamais votre mot de passe principal",
  "pricing.paidF4": "Licence stockée sur le compte ; fonctionne sur chaque appareil où vous vous connectez",
...
export const PRICING_IT: Record<string, string> = {
  ...
  "pricing.freeF3": "Sincronizzazione crittografata al tuo progetto Supabase (solo ciphertext)",
  ...
  "pricing.tierPaid": "Licenza permanente",
  ...
  "pricing.paidF1": "Voci password illimitate",
  "pricing.paidF2": "Tutto il piano Gratis, più nessun limite di voci",
  "pricing.paidF3": "Stesso modello zero-knowledge — non riceviamo mai la password principale",
  "pricing.paidF4": "Licenza salvata sull’account; funziona su ogni dispositivo con cui accedi",
...
export const PRICING_CN: Record<string, string> = {
  ...
  "pricing.freeF3": "加密同步至您的 Supabase 项目（仅密文）",
  "pricing.freeF4": "离线 JSON 备份与恢复",
  "pricing.freeFootnote":
    "达到 {{limit}} 条后，新增行将暂停，直至升级或删除条目。",
  "pricing.tierPaid": "永久许可",
  "pricing.paidOnce": "一次性 4.99 美元 — 无订阅",
  "pricing.paidDesc": "在本账户上永久解锁无限密码条目。",
  "pricing.paidF1": "无限密码条目",
  "pricing.paidF2": "包含免费版全部功能，且无条目上限",
  "pricing.paidF3": "同样的零知识模型 — 我们永远收不到您的主密码",
  "pricing.paidF4": "许可保存在账户中；在您登录的每台设备上可用",
...
export const PRICING_JP: Record<string, string> = {
  ...
  "pricing.freeF3": "Supabase プロジェクトへ暗号文のみ同期",
  "pricing.freeF4": "オフライン JSON のバックアップと復元",
  "pricing.freeFootnote":
    "{{limit}} 件に達すると、プランを上げるか削除するまで新規行の追加は一時停止されます。",
  "pricing.tierPaid": "永久ライセンス",
  "pricing.paidOnce": "一回限り 4.99 USD — サブスクなし",
  "pricing.paidDesc": "このアカウントでパスワードエントリを永久に無制限に。",
  "pricing.paidF1": "パスワードエントリ無制限",
  "pricing.paidF2": "無料プランのすべて + 件数上限なし",
  "pricing.paidF3": "同じゼロ知識モデル — マスターパスワードは受け取りません",
  "pricing.paidF4": "ライセンスはアカウントに保存。ログインする全デバイスで利用可能",
...
export const PRICING_ID: Record<string, string> = {
  ...
  "pricing.freeF3": "Sinkron terenkripsi ke proyek Supabase Anda (hanya ciphertext)",
  ...
  "pricing.tierPaid": "Lisensi permanen",
  ...
  "pricing.paidF1": "Entri kata sandi tanpa batas",
  "pricing.paidF2": "Semua fitur Gratis, plus tanpa batas entri",
  "pricing.paidF3": "Model zero-knowledge yang sama — kami tidak pernah menerima kata sandi utama Anda",
  "pricing.paidF4": "Lisensi disimpan di akun; berfungsi di setiap perangkat tempat Anda masuk",
