...
export const SETTINGS_CN: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "用此电子表格替换本设备上的所有条目？当前条目将被删除，保险库保持解锁。",
  "settings.spreadsheetImportApply": "替换条目",
  "settings.spreadsheetImportDone": "已导入电子表格。",
...
export const SETTINGS_JP: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "この端末のすべての項目をこのスプレッドシートで置き換えますか？現在の項目は削除され、Vault はロック解除のままです。",
  "settings.spreadsheetImportApply": "項目を置き換え",
  "settings.spreadsheetImportDone": "スプレッドシートをインポートしました。",
...
export const SETTINGS_ID: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "Ganti semua entri di perangkat ini dengan spreadsheet ini? Entri saat ini akan dihapus. Brankas tetap terbuka.",
  "settings.spreadsheetImportApply": "Ganti entri",
  "settings.spreadsheetImportDone": "Spreadsheet diimpor.",
...
export const SETTINGS_ES: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "¿Reemplazar todas las entradas de este dispositivo con esta hoja? Se eliminarán las entradas actuales. La bóveda permanece desbloqueada.",
  "settings.spreadsheetImportApply": "Reemplazar entradas",
  "settings.spreadsheetImportDone": "Hoja de cálculo importada.",
...
export const SETTINGS_DE: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "Alle Einträge auf diesem Gerät durch diese Tabelle ersetzen? Aktuelle Einträge werden entfernt. Der Tresor bleibt entsperrt.",
  "settings.spreadsheetImportApply": "Einträge ersetzen",
  "settings.spreadsheetImportDone": "Tabelle importiert.",
...
export const SETTINGS_FR: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "Remplacer toutes les entrées de cet appareil par ce tableur ? Les entrées actuelles seront supprimées. Le coffre reste déverrouillé.",
  "settings.spreadsheetImportApply": "Remplacer les entrées",
  "settings.spreadsheetImportDone": "Tableur importé.",
...
export const SETTINGS_IT: Record<string, string> = {
  ...
  "settings.spreadsheetImportConfirm":
    "Sostituire tutte le voci su questo dispositivo con questo foglio? Le voci attuali verranno rimosse. Il vault resta sbloccato.",
  "settings.spreadsheetImportApply": "Sostituisci voci",
  "settings.spreadsheetImportDone": "Foglio di calcolo importato.",
