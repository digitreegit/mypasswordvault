...
export const MESSAGES_EN: Record<string, string> = {
  ...
  "admin.statsFreeSignupsToday": "Sign-ups today (UTC)",
  "admin.statsSignupsTotal": "Total accounts",
  "admin.statsSignupsPlatformHint": "iOS {{ios}} · Android {{android}} · Web {{web}}",
  "admin.statsSignupsTodayHint": "New accounts since midnight UTC — not App Store downloads",
  "admin.statsSignupsTodayDetail":
    "App Store / Play downloads are not the same as account sign-ups. Only users who create an account appear here.",
  "admin.statsDownloadsVsSignupsHint":
    "App Store first-time downloads can be higher than iOS sign-ups (install without creating an account).",
  ...
  "admin.statsByRegionSignups": "Sign up by region",
  ...
  "admin.totalCount": "Total {{total}} · page {{page}}/{{pages}}",
  "admin.pageRange": "{{from}}–{{to}} of {{total}}",
  "admin.pageOf": "{{page}} / {{pages}}",
