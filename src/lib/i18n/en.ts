...
export const MESSAGES_EN: Record<string, string> = {
  ...
  "settings.navSignInLogs": "Sign-in logs",
  ...
  "account.signInEvent.signedIn": "Signed in",
  "account.signInEvent.passwordRecovery": "Password recovery",
  "account.signInDevice.desktop": "Desktop",
  "account.signInDevice.mobile": "Mobile",
  "account.signInDevice.tablet": "Tablet",
  "account.signInDevice.ios": "iPhone / iPad",
  "account.signInDevice.android": "Android",
  "account.signInDevice.unknown": "Unknown device",
  "account.signInLocation.unknown": "Unknown location",
